...
export async function LandingView() {
  ...
  return (
    <>
      {/* ── Hero ─────────────────────────────────────────────────────────
          Full-bleed, outside the PageShell: popular covers drift behind the
          copy and ambient primary glows keep the backdrop from reading as
          one flat color. Everything decorative is aria-hidden. */}
      <section className="relative isolate overflow-hidden">
        ...
        />
        <div className="relative mx-auto flex w-full max-w-[88rem] flex-col items-center gap-5 px-4 pb-20 pt-16 text-center md:pb-28 md:pt-28">
          {seasonal.length > 0 && (
