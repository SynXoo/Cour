...
// ~9 posters is ~1200px on desktop, so ×3 clears even a 2560px screen —
  ...
  return (
    ...
    >
      {/* Slight tilt + overscale so the rotated wall still covers the
          corners; opacity dims the art toward the ambient behind it. */}
      <div className="absolute inset-0 flex rotate-[-4deg] scale-110 flex-col justify-center gap-3 opacity-85 md:gap-4">
        {rows.map((row, r) => (
          <div
            key={r}
